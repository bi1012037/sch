...
<div id="today_form" align="center" style="color:blue;font-size:24px"></div>
	<div align="center">	　 　　　 　
		<table id="sch_width" class="form_line">
			...
			<tr>
				<td valign="top" align="center">小鹿<img id="websock_s" src="https://author.lugeshop.com/sch/load.png"></td>
                                <td>
                                <div style="float:left;padding:1%;">
                                <select id="deer_status" name="deer_status" style="width:110px;font-size:16px;line-height:16px;" onchange="hidden_status('deer')">
                               ...
                               <div id="deer_input" style="float:left;width:35%;padding:1%;display:none"><textarea id="deer_send_input" name="deer_input" style="width:100%;font-size:16px;height:50px;max-width: 190px;"></textarea></div>
                        ...
                        <td  style="padding:1%">
                           <form action="./upload.php?who=deer&v=2" style="margin: auto;" method="post" enctype="multipart/form-data" id="photo_upload" target="myframe">
                              <input style="width:120px;" type="file" name="my_file" accept="image/gif, image/jpeg, image/png">
                              <button onclick="document.querySelector('#photo_upload').submit();" class="btn1">上傳</button>
                           </form>
                        </td>
                        </tr>
                        <tr>
                        ...
                        <div style="float:left;padding:1%;"><button class="btn1" onclick="date_filter()" >查詢</button></div></td>
                        </tr>
			<!--<tr>
				<td align="center">小琦</td>
                                <td>
                                <div style="float:left;padding:1%;">
                                <select id="kiki_status" name="kiki_status" style="font-size:16px;" onchange="hidden_status('kiki')">
                                    <option value="0">起床囉!</option>
                                    <option value="1">準備午餐中!</option>
                                    <option value="2">出門去!</option>
                                    <option value="3">工作中!</option>
                               ...
                               <div id="kiki_input" style="float:left;width:40%;padding:1%;display:none"><input id="kiki_send_input" name="kiki_input" style="width:100%;font-size:16px;"></div>
...
$reip=get_real_ip();
$result = shell_exec("export LANG=en_US.UTF-8;/usr/bin/python3 -u /var/www/html/sch/search_no_alert_v3.py $reip 'first' 2>> /var/www/html/sch/log.txt");
echo $result;
?>
</div>
...
/*$(document).ready(function() {
    var rowCount = $("#sch_width tr").length;
    alert("表格中有 " + rowCount + " 行。");
});*/
</script>
